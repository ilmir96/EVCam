...
public class AppConfig {
    ...
    public void setAutoStartOnBoot(boolean enabled) {
        ...
        AppLog.d(TAG, "Вкл机自启动设置: " + (enabled ? "Включить" : "Отключить"));
    }
    ...
    public void setScreenOffRecordingEnabled(boolean enabled) {
        ...
        AppLog.d(TAG, "息屏录制设置: " + (enabled ? "Включить" : "Отключить"));
    }
    ...
    public void setKeepAliveEnabled(boolean enabled) {
        ...
        AppLog.d(TAG, "保活服务设置: " + (enabled ? "Включить" : "Отключить"));
    }
    ...
    public void setPreventSleepEnabled(boolean enabled) {
        ...
        AppLog.d(TAG, "防止休眠设置: " + (enabled ? "Включить" : "Отключить"));
    }
    ...
    public void resetToDefault() {
        ...
        AppLog.d(TAG, "配置Сброшено до значений по умолчанию");
    }
    ...
    public void setCameraId(String position, String cameraId) {
        ...
        AppLog.d(TAG, "Камера编号设置: " + position + " = " + cameraId);
    }
    ...
    public void setCameraName(String position, String name) {
        ...
        AppLog.d(TAG, "Камера名称设置: " + position + " = " + name);
    }
    ...
    public void setCameraRotation(String position, int rotation) {
        ...
        AppLog.d(TAG, "Камера旋转角度设置: " + position + " = " + rotation + "°");
    }
    ...
    public void setCameraMirror(String position, boolean mirror) {
        ...
        AppLog.d(TAG, position + " Камера镜像设置: " + mirror);
    }
    ...
    public void setCustomSdCardPath(String path) {
        if (path == null || path.trim().isEmpty()) {
            ...
            AppLog.d(TAG, "清除自定义U盘 кам.径，使用Авто检测");
        } else {
    ...
    public void setLastDetectedSdPath(String path) {
        if (path == null || path.trim().isEmpty()) {
            ...
            AppLog.d(TAG, "缓存U盘 кам.径: " + path.trim());
        }
    }
    ...
    public void setRelayWriteEnabled(boolean enabled) {
        ...
        AppLog.d(TAG, "中转写入设置: " + (enabled ? "Включить" : "Отключить"));
    }
    ...
    public void setFloatingWindowEnabled(boolean enabled) {
        ...
        AppLog.d(TAG, "悬浮窗设置: " + (enabled ? "Включить" : "Отключить"));
    }
    ...
    public void setSegmentDurationMinutes(int minutes) {
        ...
        AppLog.d(TAG, "分段时长设置: " + minutes + "  мин.");
    }
    ...
    public void setBlindSpotGlobalEnabled(boolean enabled) {
        ...
        AppLog.d(TAG, "补盲功能全局ВклВыкл: " + (enabled ? "Включить" : "Отключить"));
    }
    ...
    public void setSupervisionModeEnabled(boolean enabled) {
        ...
        AppLog.d(TAG, "Настройки设置: " + (enabled ? "Включить" : "Отключить"));
    }
    ...
    public void setSupervisionLeftBounds(int x, int y, int width, int height) {
        AppLog.i(TAG, "💾 保存Л视窗: x=" + x + ", y=" + y + ", w=" + width + ", h=" + height);
        prefs.edit()
    ...
    public void setSupervisionRightBounds(int x, int y, int width, int height) {
        AppLog.i(TAG, "💾 保存Пр视窗: x=" + x + ", y=" + y + ", w=" + width + ", h=" + height);
        prefs.edit()
    ...
    public void setLongViewModeEnabled(boolean enabled) {
        ...
        AppLog.d(TAG, "长视模式设置: " + (enabled ? "Включить" : "Отключить"));
    }
    ...
    public void resetSupervisionBounds() {
        ...
        AppLog.i(TAG, "🎯 重置НастройкиПо умолчаниюПозиция: Л窗口(" + leftX + "," + leftY + "), Пр窗口(" + rightX + "," + rightY + "), 尺寸=" + width + "x" + height);
    }
    ...
    public void setSecondaryDisplayEnabled(boolean enabled) {
        ...
        AppLog.d(TAG, "副屏显示设置: " + (enabled ? "Включить" : "Отключить"));
    }
    ...
    public void setPreviewCorrectionEnabled(boolean enabled) {
        ...
        AppLog.d(TAG, "预览画面矫正设置: " + (enabled ? "Включить" : "Отключить"));
    }
    ...
    public void setFisheyeCorrectionEnabled(boolean enabled) {
        ...
        AppLog.d(TAG, "鱼眼矫正设置: " + (enabled ? "Включить" : "Отключить"));
    }
    ...
    public void setMainFloatingEnabled(boolean enabled) {
        ...
        AppLog.d(TAG, "主屏悬浮窗设置: " + (enabled ? "Включить" : "Отключить"));
    }
    ...
    public void setTurnSignalLinkageEnabled(boolean enabled) {
        ...
        AppLog.d(TAG, "转向灯联动设置: " + (enabled ? "Включить" : "Отключить"));
    }
   ...
   public int getTurnSignalTimeout() {
    ...
    public void setDoorLinkageEnabled(boolean enabled) {
        ...
        AppLog.d(TAG, "车门联动设置: " + (enabled ? "Включить" : "Отключить"));
    }
    ...
    public void setTimestampWatermarkEnabled(boolean enabled) {
        ...
        AppLog.d(TAG, "时间角标设置: " + (enabled ? "Включить" : "Отключить"));
    }
    ...
    public java.util.Set<String> getEnabledRecordingCameras() {
        ...
        if (enabled.isEmpty()) {
            AppLog.w(TAG, "没有Включить的录制Камера，АвтоВключить所有可用Камера");
    ...
    public void setImageAdjustEnabled(boolean enabled) {
        ...
        AppLog.d(TAG, "亮度/降噪调节设置: " + (enabled ? "Включить" : "Отключить"));
    }
    ...
    public void resetImageAdjustParams() {
        prefs.edit()
            ...
            .apply();
        AppLog.d(TAG, "亮度/降噪调节参数Сброшено до значений по умолчанию");
    }
    ...
    public void setCustomFreeControlEnabled(boolean enabled) {
        ...
        AppLog.d(TAG, "自由操控设置: " + (enabled ? "Включить" : "Отключить"));
    }
    ...
    public void setAvmAvoidanceEnabled(boolean enabled) {
        ...
        AppLog.d(TAG, "全景影像避让设置: " + (enabled ? "Включить" : "Отключить"));
    }
    ...
    public void setCustomKeyWakeupEnabled(boolean enabled) {
        ...
        AppLog.d(TAG, "定制键唤醒设置: " + (enabled ? "Включить" : "Отключить"));
    }
    ...
    public void setFrontWheelLeftViewParams(int width, int height, int x, int y, int rotation) {
        prefs.edit()
                ...
                .apply();
        AppLog.d(TAG, "П轮模式Л视图参数已保存: " + width + "x" + height + " @(" + x + "," + y + ") Поворот " + rotation + "°");
    }
    ...
    public void setFrontWheelRightViewParams(int width, int height, int x, int y, int rotation) {
        prefs.edit()
                ...
                .apply();
        AppLog.d(TAG, "П轮模式Пр视图参数已保存: " + width + "x" + height + " @(" + x + "," + y + ") Поворот " + rotation + "°");
    }
    ...
    public void setRearWheelLeftViewParams(int width, int height, int x, int y, int rotation) {
        prefs.edit()
                ...
                .apply();
        AppLog.d(TAG, "З轮模式Л视图参数已保存: " + width + "x" + height + " @(" + x + "," + y + ") Поворот " + rotation + "°");
    }
    ...
    public void setRearWheelRightViewParams(int width, int height, int x, int y, int rotation) {
        prefs.edit()
                ...
                .apply();
        AppLog.d(TAG, "З轮模式Пр视图参数已保存: " + width + "x" + height + " @(" + x + "," + y + ") Поворот " + rotation + "°");
    }
    ...
    public void setNormalLeftViewParams(int width, int height, int x, int y, int rotation) {
        prefs.edit()
                ...
                .apply();
        AppLog.d(TAG, "普通模式Л视图参数已保存: " + width + "x" + height + " @(" + x + "," + y + ") Поворот " + rotation + "°");
    }
    ...
    public void setNormalRightViewParams(int width, int height, int x, int y, int rotation) {
        prefs.edit()
                ...
                .apply();
        AppLog.d(TAG, "普通模式Пр视图参数已保存: " + width + "x" + height + " @(" + x + "," + y + ") Поворот " + rotation + "°");
    }
    ...
    public void resetFrontWheelViewParams() {
        ...
        AppLog.d(TAG, "П轮模式视图参数Сброшено до значений по умолчанию");
    }
    ...
    public void resetRearWheelViewParams() {
        ...
        AppLog.d(TAG, "З轮模式视图参数Сброшено до значений по умолчанию");
    }
    ...
    public void resetNormalViewParams(int defaultLeftWidth, int defaultLeftHeight, int defaultRightWidth, int defaultRightHeight, int containerHeight) {
        ...
        AppLog.d(TAG, "普通模式视图参数Сброшено до значений по умолчанию");
    }
    ...
    public void setUseNewRecordingArchitecture(boolean enabled) {
        ...
        AppLog.d(TAG, "新录制架构设置: " + (enabled ? "Включить" : "Отключить"));
    }
    ...
    public void setRecordingFloatingEnabled(boolean enabled) {
        ...
        AppLog.d(TAG, "录制悬浮按钮设置: " + (enabled ? "Включить" : "Отключить"));
    }
