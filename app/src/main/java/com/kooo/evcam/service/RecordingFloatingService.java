...
public class RecordingFloatingService extends Service {
    ...
    private void toggleRecording() {
        ...
        switch (appState) {
            ...
            case NOT_RUNNING:
                ...
                Toast.makeText(this, "Запускаю запись, подождите...", Toast.LENGTH_SHORT).show();
                return;
        }
    }
    ...
    private void tryStartOrStopRecording(int retryCount) {
        ...
        if (recordingService != null) {
            ...
            Toast.makeText(this, "Не удалось запустить сервис записи, повторите попытку", Toast.LENGTH_SHORT).show();
        }
    }
